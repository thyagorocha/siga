...
<mod:modelo salvarViaAjax="N" acaoGravar="gravarBI" acaoExcluir="excluirBI" acaoCancelar="refazerBI" acaoFinalizar="finalizarBI">
	<mod:entrevista>
		<mod:grupo>
			<mod:texto titulo="Nome do Diretor do Foro" var="nmDiretorForo" valor="Dr. Alexandre Libonati de Abreu" largura="40"/>
		</mod:grupo>
		<mod:grupo>
			<mod:texto titulo="Nome do Diretor da SG" var="nmDiretorRH" valor="Patrícia Reis Longhi" largura="40" />
		</mod:grupo>
		<mod:grupo>
			<mod:texto titulo="Setores Responsáveis" var="setoresResponsaveis" valor="DIRFO: NAGB / SGP: SEPRF, SEBEN, SECAD, SELEG, SELOT, SESAU / SOF / SG" largura="90"/>
		</mod:grupo>
		<mod:grupo>
