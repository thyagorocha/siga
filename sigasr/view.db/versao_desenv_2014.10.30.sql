-- Não é possível renderizar a DLL VIEW para o objeto SIGARH.DADOS_RH com o DBMS_METADATA tentando um gerador interno.
CREATE OR REPLACE VIEW SIGARH.DADOS_RH
AS SELECT RH.ID_CAD_RECURSO_HUMANO AS PESSOA_ID,
  ...
  WHERE RH.ID_CAD_ORGAO       IN (1,2)
  AND U.ID_CAD_ORGAO          IN (1,2)
  ...
  AND PF.ID_CAD_NACIONALIDADE = NAC.ID_CAD_NACIONALIDADE
  UNION
  --SERVIDOR REQUISITADO DA CARREIRA JUDICIÃ?RIA
  SELECT RH.ID_CAD_RECURSO_HUMANO AS PESSOA_ID,
    PF.CPF                        AS PESSOA_CPF,
    PF.NM_PESSOA                  AS PESSOA_NOME,
    PF.SEXO                       AS PESSOA_SEXO,
  ...
  AND U.ID_CAD_ORGAO    IN (1,2)
  UNION
  --SERVIDOR REQUISITADO SEM VÃ?NCULO
  SELECT RH.ID_CAD_RECURSO_HUMANO AS PESSOA_ID,
    PF.CPF                        AS PESSOA_CPF,
    PF.NM_PESSOA                  AS PESSOA_NOME,
    PF.SEXO                       AS PESSOA_SEXO,
  ...
  AND U.ID_CAD_ORGAO    IN (1,2)
  UNION
  --SERVIDOR REQUISITADO DE OUTROS ÃRGÃOS
  SELECT RH.ID_CAD_RECURSO_HUMANO AS PESSOA_ID,
    PF.CPF                        AS PESSOA_CPF,
    PF.NM_PESSOA                  AS PESSOA_NOME,
    PF.SEXO                       AS PESSOA_SEXO,
  ...
  INNER JOIN SIGARH.LOT_TIPO_CATEGORIA_FUNCIONAL LTCF
  ON LTCF.ID_LOT_TP_CATEGORIA_FUNCIONAL = LETF.ID_LOT_TP_CATEGORIA_FUNCIONAL
  WHERE CRE.ID_CAD_ORGAO                IN (1,2)
  AND U.ID_CAD_ORGAO                    IN (1,2)
  UNION
  --JUIZ COM LOTAÃÃO TITULAR EXIBINDO SOMENTE A LOTAÃÃO TITULAR
  SELECT RH.ID_CAD_RECURSO_HUMANO AS PESSOA_ID,
    PF.CPF                        AS PESSOA_CPF,
    PF.NM_PESSOA                  AS PESSOA_NOME,
    PF.SEXO                       AS PESSOA_SEXO,
  ...
  AND U.ID_CAD_ORGAO    IN (1,2)
  UNION
  --JUIZ SOMENTE COM LOTAÃÃES SUBSTITUTAS EXIBINDO SOMENTE A LOTAÃÃO SUBSTITUTA COM MAIOR DATA DE INÃ?CIO
  SELECT RH.ID_CAD_RECURSO_HUMANO AS PESSOA_ID,
    PF.CPF                        AS PESSOA_CPF,
    PF.NM_PESSOA                  AS PESSOA_NOME,
    PF.SEXO                       AS PESSOA_SEXO,
